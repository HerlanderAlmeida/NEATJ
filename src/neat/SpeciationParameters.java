	...
	int staleGenerationsAllowed, double deadbeatEvaluation, int preservedSpecies)
{
	...
	public static class Builder
	{
		...
		{
			return new SpeciationParameters(excessCoefficient, disjointCoefficient,
				weightDifferenceCoefficient, desiredSpecies, differenceThreshold,
				differenceThresholdStep, crossoverProbability, eliminationRate,
				staleGenerationsAllowed, deadbeatEvaluation, preservedSpecies);
		}
	}
}
